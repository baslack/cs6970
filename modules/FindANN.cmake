# Original Source: https://github.com/appliedtopology/ctl/blob/master/dependencies/CMakeModules/FindANN.cmake
# Credit: Ryan H. Lewis, https://github.com/rhl-
# Notes:
# Appears to suggest that ANN_DIR environment variable exists
...
FIND_LIBRARY(ANN_LIBRARY NAMES ANN
	PATHS 
		...
		/opt/local/lib  
		$ENV{ANN_DIR}/lib
		$ENV{ANN_DIR}/MS_Win32/dll/Release
)
if( NOT ANN_LIBRARY)
FIND_LIBRARY(ANN_LIBRARY NAMES ann  
	PATHS 
